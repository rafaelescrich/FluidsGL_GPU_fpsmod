...
// Modifications by Jesús Martín Berlanga
//     - fps benchmark when executing with the 'stress_test' argument
...
void display(void)
{
    ...
    if (fpsCount == fpsLimit)
    {
    	...
    	if(stress_test) {
       		printf("%f fps (%d/%d)\n",ifps,stress_test_step_index,stress_test_n_steps);
		fps_accumulation += ifps;
		fps_n_accumulations++;
...
int main(int argc, char **argv)
{
    ...
    if (strcmp(lastArg,"stress_test") == 0)
    {
